  ...
  "active": [
    {
      "id": 141,
      "name": "#play",
      "createdAt": "2019-11-12T10:47:09.000Z",
      "updatedAt": "2019-11-12T10:47:31.000Z",
      "hexCode": null,
      "contestId": 2,
      "status": "Round 2",
      "image": 458033,
      ...
      "critters": 1,
      "entryFee": 100,
      "voteDate": "2019-11-12T10:47:09.000Z",
      "winner": null,
      "winDate": null,
      "currentRound": 2,
      "prompt": null,
  ...
  "open": [
    {
      "id": 140,
      "name": "#highTechPet",
      "createdAt": "2019-11-12T10:46:36.000Z",
      "updatedAt": "2019-11-12T10:46:36.000Z",
      "hexCode": null,
      "contestId": 14,
      "status": "Open",
      "image": 705922,
      "votingStartsIn": 173759.974,
      "numRounds": 4,
      "levelRequirements": "2 & below",
      "numPets": 16,
      "spotsLeft": 12,
      "entriesPerPet": 3,
      "minLevel": null,
      ...
      "critters": 1,
      "entryFee": 100,
      "voteDate": "2019-11-15T10:46:36.000Z",
      "winner": null,
      "winDate": null,
      "currentRound": 1,
      "prompt": null,
  ...
  "ended": [
    {
      "id": 145,
      "name": "#naptime",
      "createdAt": "2019-11-12T10:49:39.000Z",
      "updatedAt": "2019-11-12T10:50:18.000Z",
      "hexCode": null,
      "contestId": 5,
      "status": "Closed",
      "image": 4352,
      "votingStartsIn": 173942.974,
      "numRounds": 4,
      "levelRequirements": "Any",
      "numPets": 16,
      "spotsLeft": 0,
      ...
      "critters": 1,
      "entryFee": 100,
      "voteDate": "2019-11-15T10:49:39.000Z",
      "winner": 986,
      "winDate": "2019-11-12T10:50:18.000Z",
      "currentRound": 4,
      "prompt": null,
      "sponsor": null
    }
...
This endpoint returns the list of all tournaments, grouped by their status as active, open, and ended Tournament.
...
<aside class="success">
Returns list of all Tournaments, grouped by their status.
</aside>

## Get Tournament Match

```shell
curl "https://api.parade.pet/v2/tournament/match/:id"
  -H "Authorization: Bearer meowmeowmeow"
```
...
```json
{
  ...
  "pointsA": 1,
  "pointsB": 74,
  "winDate": "2019-11-12T10:48:31.000Z",
  "startDate": "2019-11-12T10:48:29.000Z",
  "id": 1148,
  "createdAt": "2019-11-12T10:47:55.000Z",
  "updatedAt": "2019-11-12T10:48:31.000Z",
  "tournament": 142,
  "entryA": {
    "id": 945,
    "pet": {
    ...
    "owner": {
      ...
      "firstName": "Ashley",
      "lastName": "Maebelle",
      "fullName": "Ashley Maebelle",
      "initials": "AM",
      "profileImage": null,
      "socialImageUrl": "https://graph.facebook.com/v2.7/10154758656237036/picture?height=100&width=100",
      "silverCoins": 1490,
      "goldCoins": 65,
      "prizeTickets": 0,
      "level": {
  ...
  "entryB": {
    ...
    "owner": {
      ...
      "firstName": "Kyle",
      "lastName": "Maloney",
      "fullName": "Kyle Maloney",
      "initials": "KM",
      "profileImage": null,
      "socialImageUrl": "https://graph.facebook.com/v2.7/1776821842344435/picture?height=100&width=100",
      "silverCoins": 0,
      "goldCoins": 0,
      "prizeTickets": 0,
      "level": {
  ...
  "winnerGets": {
    ...
    "prize": {
      ...
      "imageUrl": "https://images-na.ssl-images-amazon.com/images/I/91glPB6dedL._SL600_.jpg",
      "brand": "BSeen",
      "description": "Help your dog stand out on evening walks with this glowing safety collar. The collar is green. Please select a size when redeeming. (Small: 14.2-17.3 inch Medium: 17.3-21.2 inch Large: 22.2-24.4 inch)"
    }
  },
  "feed": [
    {
...
This endpoint returns all data related to a Tournament Match.

### HTTP Request

`GET http://api.parade.pet/v2/tournament/match/:id`
...
Parameter | Required | Description
--------- | ------- | -----------
id | true | Tournament Match ID value, passed in the url path

<aside class="success">
Returns detailed Tournament Match data, including both entries participating in current Tournament Match, current round Tournament Match prize, and Tournament Match Feed. 
</aside>
...
## Accept Tournament Prize

```shell
curl "https://api.parade.pet/v2/tournament/match/acceptPrize/:id"
  -H "Authorization: Bearer meowmeowmeow"
  -d "addressId=1234"
```
...
Use this endpoint to accept a Tournament Match Prize.
...
--------- | ------- | -----------
id | true | Tournament Match ID value, passed in the url path
addressId | false | ID of the Address object to ship to 
